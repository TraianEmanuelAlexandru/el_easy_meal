...
class DetailScreenSearch extends StatefulWidget {
  ...
  DetailScreenSearch(this.searchRecipe, this.inFavorites);

  @override
  _DetailScreenSearchState createState() => _DetailScreenSearchState();
}
...
class _DetailScreenSearchState extends State<DetailScreenSearch>
  ...
  Future<void> setRecipe(SearchRecipe searchRecipe) async {
    final a = searchRecipe;
  ...
  Future<Recipe> getRecipe(final SearchRecipe searchRecipe) async {
    final url = "https://api.spoonacular.com/recipes/${searchRecipe.id}/information?apiKey=9d2e738d96164cbebca82b6c4ead7822";
...
//e113f9009c4b4752b855a0239efc1e35
